...
namespace GestionBox.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoxUserHorarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoxUserHorarios_AspNetUsers_BoxUserId",
                        column: x => x.BoxUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BoxUserHorarios_Horarios_HorarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoxUserHorarios_BoxUserId",
                table: "BoxUserHorarios",
                column: "BoxUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BoxUserHorarios_HorarioId",
                table: "BoxUserHorarios",
                column: "HorarioId");
